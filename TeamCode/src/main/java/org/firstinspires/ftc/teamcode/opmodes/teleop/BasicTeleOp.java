...
public class BasicTeleOp extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            /*
             * the goal here is to allow the arm to extend, yet future mieasures should be
             * upgraded.
             */
            if (gamepad1.x) {
            ...
            if (qrData != null && !qrData.equals(lastQrData)) {
                gamepad1.rumble(500); // Alert driver of new identification
                lastQrData = qrData;
            }
