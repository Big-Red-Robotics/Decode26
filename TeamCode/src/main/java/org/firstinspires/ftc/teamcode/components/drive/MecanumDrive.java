...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.0019617888;
        public double lateralInPerTick = 0.00125193856806498;
        public double trackWidthTicks = 7284.199373070882;

        // feedforward parameters (in tick units)
        public double kS = 1.3838046382995843;
        public double kV = 0.0002568376184360458;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftBack = hardwareMap.get(DcMotorEx.class, "dFR");
        rightBack = hardwareMap.get(DcMotorEx.class, "dBR");
        rightFront = hardwareMap.get(DcMotorEx.class, "dBL");
