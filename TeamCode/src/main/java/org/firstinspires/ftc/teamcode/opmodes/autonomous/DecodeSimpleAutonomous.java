...
/**
 * DECODE 2025-2026 Simple Autonomous
 *
 ...
 *
 * Use this when you need reliability over maximum scoring.
 */
@Autonomous(name = "DECODE Simple - Blue", group = "DECODE")
public class DecodeSimpleAutonomous extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.addLine("Blue Alliance - RELIABLE MODE");
        telemetry.addLine("");
